...
if(isset($_POST['CPU'])){
    ...
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            ...
            // 公司與報表名稱
            $title = '
    <h4 style="font-size: 20pt; font-weight: normal; text-align: center;">電腦硬體需求分析平台</h4>

    <table>
        <tr>
            <td style="width: 30%;"></td>
            <td style="border-bottom: 2px solid black; font-size: 20pt; font-weight: normal; text-align: center; width: 40%;">產品清單</td>
            <td style="width: 30%;"></td>
        </tr>
        <tr>
            <td colspan="3"></td>
    ...
    $product_id = ["中央處理器CPU","主機板Mother Board","圖形處理器GPU","記憶體Memory","固態硬碟SSD","傳統硬碟HDD","功耗Power","金額Price"];
    $product_name = [$CPU,$MB,$GPU,$Memory,$SSD,$HDD,$Power,$Price];
    ...
    for ($i = 0; $i < count($product_id); $i++) {
        ...
        $html .= '
            <tr>
                <td style="line-height: 1.5; width: 20%;text-align: left;">' . $product_id[$i] . '</td>
                <td style="line-height: 1.5; width: auto;text-align: left;">' . $product_name[$i] . '</td>
                </tr>';
            }
